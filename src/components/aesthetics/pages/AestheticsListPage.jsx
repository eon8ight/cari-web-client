...
const AestheticsListPage = (props) => {
  ...
  const callApiCallback = useCallback(callApi, [asc, keyword, peakYear, requestMade, sortField, startYear]);
      ...
      <form onSubmit={handleSubmit}>
        <FormGroup label="Search and filter by...">
          <ControlGroup>
            ...
            <NumericInput onChange={handlePeakYearChange} placeholder="Peak Year" value={peakYear || ''} />
